...
import * as cardLayoutView from "./views/cardLayoutView";
import * as cardsView from "./views/cardsView";
import * as cluesView from "./views/cluesView";
import * as currentPlayerAreaView from "./views/currentPlayerAreaView";
import * as deckView from "./views/deckView";
import * as gameInfoView from "./views/gameInfoView";
...
import * as spectatorsView from "./views/spectatorsView";
import * as statsView from "./views/statsView";
import * as turnView from "./views/turnView";
...
const visibleStateObservers: Subscriptions = [
  ...
  subVS(
    (s) => s.stats.numAttemptedCardsPlayed,
...
const replayObservers: Subscriptions = [
  ...
  subAfterInit(
    (s) => ({ finished: s.finished, shared: s.replay.shared !== null }),
